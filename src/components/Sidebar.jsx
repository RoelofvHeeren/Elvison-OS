...
const Sidebar = ({ collapsed, onToggle }) => (
  <aside
    className={`sticky top-0 h-screen shrink-0 flex flex-col border-r-2 border-teal-accent bg-black/90 px-6 py-8 shadow-2xl backdrop-blur-md z-50 ${collapsed ? 'w-20' : 'w-72'
